...
#This sample demonstrates transmitting board temperature over the LoRaWAN protocol. (For EU version.)
...
lora = Turta_LoRa.RN2XX3(region = Turta_LoRa.REGIONS.EU_RN2483, auto_config = Turta_LoRa.CONFIG_MODES.LORA_TX)
